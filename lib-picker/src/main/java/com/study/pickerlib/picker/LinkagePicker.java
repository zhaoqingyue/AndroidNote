package com.study.pickerlib.picker;
...
import com.study.pickerlib.adapter.ArrayWheelAdapter;
...
public class LinkagePicker extends WheelPicker {
    ...
    public void setOnMoreItemPickListener(OnMoreItemPickListener<String> onMoreItemPickListener) {
    ...
    protected int[] getColumnWidths(boolean onlyTwoColumn) {
        LogUtils.v(String.format(java.util.Locale.CHINA, "column weight is: %f-%f-%f", firstColumnWeight, secondColumnWeight, thirdColumnWeight));
        ...
        if(wheelModeEnable){
            ...
            firstView.setOnItemPickListener(new OnItemPickListener<String>() {
                ...
                public void onItemPicked(int i,String item) {
                    ...
                    LogUtils.e("ZQY", "change second data after first wheeled");
//                    if (!canLinkage) {
//                        return;
//                    }
                    //根据第一级数据获取第二级数据
...
//                    }
                    ...
                    LogUtils.e("ZQY", "change third data after second wheeled");
                    List<String> thirdData = provider.provideThirdData(selectedFirstIndex, selectedSecondIndex);
                    //根据第二级数据获取第三级数据
                    thirdView.setAdapter(new ArrayWheelAdapter<>(thirdData));
                    thirdView.setCurrentItem(selectedThirdIndex);
