...
//
//    public static void hideAirCondationBar(boolean hide) {
//        StatusBarManager statusBarManager = (StatusBarManager) NegScreenApp.getInstance().getSystemService(Context
//                .STATUS_BAR_SERVICE);
//        statusBarManager.setHideAirCondationBar(hide);
//    }
}
