...
import com.study.commonlib.bean.AppInfo;
...
public class AppUtils {
    ...
    public static void installApp(Context context, File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            // package + ".fileProvider"即是在清单文件中配置的authorities
    ...
    public static void launchApp(Context context, String packageName) {
        ...
        if (intent == null) {
            String str = context.getResources().getString(R.string.toast_app_not_install);
...
//    }
    ...
    private static AppInfo getBean(PackageManager pm, PackageInfo pi) {
        ...
        return new AppInfo(appName, appIcon, packageName, packagePath, versionName, versionCode, isSystem);
    }
